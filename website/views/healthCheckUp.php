                            ...
                            <div class="card-body ml-5">
                                ...
                                <div class="row mr-5">
                                    <div class="col-md-12">
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="custom1"
                                                name="custom1[]" value="تسارع النفس">
                                            <label class="custom-control-label" for="custom1">صعوبة شديدة بالتنفس
                                                (انقطاع او تسارع النفس)</label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="custom2"
                                                name="custom1[]" value="ألم مستمر في">
                                            <label for="custom2" class="custom-control-label">
                                                ألم مستمر في الصدر
                                            </label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="custom3"
                                                name="custom1[]" value="زرقة الشفاه أو الوجه">
                                            <label for="custom3" class="custom-control-label">
                                                زرقة الشفاه أو الوجه
                                            </label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="custom4"
                                                name="custom1[]" value="عدم القدرة على النهوض">
                                            <label for="custom4" class="custom-control-label">
                                                ارهاق شديد و عدم القدرة على النهوض
                                            </label>
                                        </div>
                                        <div class="custom-control custom-checkbox">
                                            <input class="custom-control-input" type="checkbox" id="custom5"
                                                name="custom1[]" value="لا شيء مما ذكر">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row mr-5">
                                        <div class="col-md-4">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="custom6"
                                                    name="custom2[]" value="حمى">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <<input class="custom-control-input" type="checkbox"
                                                    id="custom7" name="custom2[]" value="سعال جاف">
                                                    <label for="custom7" class="custom-control-label">
                                                        سعال جاف
                                                    </label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="custom8"
                                                    name="custom2[]" value="صداع">
                                                <label for="custom8" class="custom-control-label">
                                                    صداع
                                                </label>
                                            </div>
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox" id="custom9"
                                                    name="custom2[]" value="ارهاق عام">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom10" name="custom2[]" value=" صعوبة خفيفة بالتنفس">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom11" name="custom2[]" value="الم في العظام">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom12" name="custom2[]" value="ألم في الحلق">
                                        ...
                                        <div class="col-md-4">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom13" name="custom2[]" value="إسهال">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom14" name="custom2[]" value="قشعريرة">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom15" name="custom2[]" value="غثيان">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom16" name="custom2[]" value="احتقان في الانف">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom17" name="custom2[]" value="استفراغ">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom18" name="custom2[]" value="بلغم مع دم">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom19" name="custom2[]" value="دوار">
                                        ...
                                        <div class="col-md-4">
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom20" name="custom2[]" value="الم في العضلات">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom21" name="custom2[]" value="فقدان الشهية">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom22" name="custom2[]" value="فقدان حاسة الشم">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom23" name="custom2[]" value="فقدان حاسة الذوق">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom24" name="custom2[]" value="انتفاخ العين">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom25" name="custom2[]" value="احمرار بالعين">
                                            ...
                                            <div class="custom-control custom-checkbox">
                                                <input class="custom-control-input" type="checkbox"
                                                    id="custom26" name="custom2[]" value="لا شيء مما ذكر">
